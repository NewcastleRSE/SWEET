export function sideEffectFormRenderer(section) {
    ...
    .then(schema => {
        form.innerHTML =  `
            ...
            <span id="severityinput"><label class="scale">A little</label> <input type="range" min="1" max="5" step="1" class="form-range" name="severity"> <label class="scale">Extremely</label></span><br></span>
            ...
            <span id="impactinput"><label class="scale">A little</label> <input type="range" min="1" max="5" step="1" class="form-range" name="impact"> <label class="scale">A lot</label></span><br></span>
